...
const ConstellationWebGL = (function() {
        ...
        orb: {
            ...
            fragment: `
                ...
                void main() {
                    ...
                    vec3 envReflection = textureCube(uEnvMap, reflectDir).rgb * 0.9;

                    // === SIMULATED REFRACTION (glass IOR ~1.45) ===
                    vec3 refractDir = refract(-V, N, 1.0 / 1.45);
                    vec3 envRefraction = textureCube(uEnvMap, refractDir).rgb * 0.6;
    ...
    function createEnvironmentCubemap(gl) {
        ...
        for (let face = 0; face < 6; face++) {
            ...
            gradient.addColorStop(0, '#3060a0');   // Bright blue center
            gradient.addColorStop(0.5, '#1a3060'); // Rich mid blue
            gradient.addColorStop(1, '#0c1830');   // Visible blue edge
            ...
            nebulaGradient.addColorStop(0, 'rgba(100, 160, 255, 0.5)');
            nebulaGradient.addColorStop(0.5, 'rgba(140, 100, 220, 0.35)');
